            ...
            %page-sequence!master-reference=body
                ...
                %flow!flow-name=xsl-region-body!text-align=justify
                    ...
                    $forall chapterIntro.c b
                        ^block.b^
                    $forall chapterSections.c s
                        ^(section.h1).s^
                    $maybe chapterSummary.c s
...
inline (Link _ _ text) = [$xhamlet|$text$|] -- FIXME
inline (Abbr _ text) = [$xhamlet|$text$|] -- FIXME
