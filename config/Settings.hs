...
--
-- If you change the resource pattern for StaticR in Wiki.hs, you will
-- have to make a corresponding change here.
--
-- To see how this value is used, see urlRenderOverride in Wiki.hs
staticroot :: Text
...
connStr :: Text
#ifdef PRODUCTION
connStr = "user=yesodwiki password=yesodwiki host=localhost port=5432 dbname=yesodwiki_production"
#else
connStr = "user=yesodwiki password=yesodwiki host=localhost port=5432 dbname=yesodwiki_debug"
#endif
