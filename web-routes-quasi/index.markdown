...
---
Current version: **[0.6.0](http://hackage.haskell.org/package/web-routes-quasi-0.6.0)**. Code repo: [http://github.com/snoyberg/web-routes-quasi](http://github.com/snoyberg/web-routes-quasi)
